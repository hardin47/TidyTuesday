...
Sadly, plotly won't work with `coord_polar()`. So we can't create a pulldown menu for the station. We could if we used shiny, but that isn't in the cards for today. 
