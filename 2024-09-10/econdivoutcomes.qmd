...
Regardless, we will continue with the `attend` variable as some measure of attendance as a function of income percentile of the parents.  The code for highlighting the lines was taken from <a href = "https://talks.cpsievert.me/20210624/#1" target = "_blank">Augmenting data exploration with interactive web graphics</a> by Carson Sievert.
