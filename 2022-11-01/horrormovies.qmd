...
Finally got the refresh to work!!!   The Shiny App is hosted at: <a href = "https://hardin47.shinyapps.io/horrormovies/" target = "_blank">https://hardin47.shinyapps.io/horrormovies/</a>
...
```{r}
#| fig-cap: A horror movie poster created from the parts of speech taken from the titles of a large horror movie dataset.
#| fig-alt: "A horror movie poster created from the parts of speech taken from the titles of a large horror movie dataset. This one says 'The Tales at the Paranormal Exorcism: We will be rising...' "
make_poster(seed = 4774)
```


## Movie Titles

The Shiny App is at: https://hardin47-horror-movies.share.connect.posit.cloud/
...
p <- make_poster(seed = 4774)

png(filename = "horrorposter.png", width = 650, height = 450)
